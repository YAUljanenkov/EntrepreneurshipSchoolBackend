...
{
    /// <inheritdoc />
    public partial class _14JulyUpdate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Messenger = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    Gender = table.Column<char>(type: "character(1)", nullable: true),
                    EmailLogin = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    ...
                    ResultGrade = table.Column<double>(type: "double precision", nullable: false),
                    GradeBonus = table.Column<double>(type: "double precision", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PresLink = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    VideoLink = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Terms = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    Performer = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Relates", x => new { x.LearnerId, x.GroupId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    Criteria = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssessmentsType = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Solutions", x => new { x.TaskId, x.LearnerId, x.GroupId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Attends", x => new { x.LearnerId, x.LessonId });
                    table.ForeignKey(
